...
namespace _5Class
{
    ...
    { // attribute - data
        ...
        // static data area 에 생성
        private static double interest; // 이자율 <== 항상 똑같은 값을 가진다고 가정.
        ...
        {
            // this. , static 키워드가 붙지 않은 필드는 못쓴다.
            // this.interest = d;
            interest = d;
        }
        ...
        {
            if (a.accNo == b.accNo && a.Name == b.Name && a.balance == b.balance)
                return true;
            else
                return false;
        }
